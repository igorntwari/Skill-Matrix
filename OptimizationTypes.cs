...
public class OptimizationConstraintsInput
{
    ...
    public bool? RequireBackupCoverage { get; set; }
    public int? MinBufferHoursPerPerson { get; set; }
    public List<Guid>? RequiredEmployees { get; set; }
    public List<Guid>? ExcludedEmployees { get; set; }
}
