...
namespace SkillMatchPro.Infrastructure.Migrations
{
    ...
    [Migration("20250821072859_AddWorkSchedulesv3")]
    partial class AddWorkSchedulesv3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillMatchPro.Domain.Entities.EmployeeProjectPerformance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("BugsReported")
                        .HasColumnType("integer");

                    b.Property<int>("CodeReviewIssues")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TasksDeliveredOnTime")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EmployeeProjectPerformances");
                });
            ...
            modelBuilder.Entity("SkillMatchPro.Domain.Entities.ProjectRequirement", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "SkillId", "MinimumProficiency")
                        .IsUnique()
            ...
            modelBuilder.Entity("SkillMatchPro.Domain.Entities.TeamCollaboration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("CollaborationScore")
                        .HasColumnType("numeric");

                    b.Property<int>("CommunicationRating")
                        .HasColumnType("integer");

                    b.Property<int>("ConflictsEscalated")
                        .HasColumnType("integer");

                    b.Property<int>("ConflictsResolved")
                        .HasColumnType("integer");

                    b.Property<string>("Employee1Feedback")
                        .HasColumnType("text");

                    b.Property<Guid>("Employee1Id")
                        .HasColumnType("uuid");

                    b.Property<string>("Employee2Feedback")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("WouldWorkTogetherAgain")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("Employee1Id", "Employee2Id", "ProjectId");

                    b.ToTable("TeamCollaborations");
                });
